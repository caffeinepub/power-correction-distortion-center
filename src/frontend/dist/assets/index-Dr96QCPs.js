...
const COMMANDER = 125e9;
const CORRECTION_PASSES = 125e9;
const MONITOR = 125e9;
const COMBINED_CORRECTION = COMMANDER * CORRECTION_PASSES * MONITOR;
const METER_MIN = -60;
const METER_MAX = 0;
function buildStabilizerCurve(samples = 4096) {
  const curve = new Float32Array(samples);
  const norm = Math.log1p(COMBINED_CORRECTION) / 50;
  for (let i = 0; i < samples; i++) {
    const x2 = i * 2 / (samples - 1) - 1;
    curve[i] = Math.tanh(x2 * norm);
  }
  return curve;
}
...
const METER_ZONES = [
  { from: -60, to: -20, color: "#3b82f6" },
  // safe — blue
  { from: -20, to: -6, color: "#eab308" },
  // nominal — yellow
...
function App() {
  ...
  const gainVolumeRef = reactExports.useRef(null);
  const stabilizerNodeRef = reactExports.useRef(null);
  ...
  const [fileName, setFileName] = reactExports.useState("NO FILE LOADED");
  const [isPlaying, setIsPlaying] = reactExports.useState(false);
  const [duration, setDuration] = reactExports.useState(0);
  const [currentTime, setCurrentTime] = reactExports.useState(0);
  const [loudBooster, setLoudBooster] = reactExports.useState(0);
  const [stabilizerOn, setStabilizerOn] = reactExports.useState(false);
  const [isDragging, setIsDragging] = reactExports.useState(false);
  const [meterDb, setMeterDb] = reactExports.useState(METER_MIN);
  const getCtx = reactExports.useCallback(() => {
    if (!audioCtxRef.current) audioCtxRef.current = new AudioContext();
    return audioCtxRef.current;
  }, []);
  const buildGraph = reactExports.useCallback(
    (stabOn, boosterVal) => {
      var _a2;
      const ctx = getCtx();
      ...
      for (const r of cleanupNodes) {
        try {
          (_a2 = r.current) == null ? void 0 : _a2.disconnect();
        } catch {
        }
      }
      ...
      if (stabOn) {
        ...
        stabilizer.curve = buildStabilizerCurve();
      ...
      return stabOn ? stabilizerNodeRef.current : gainNode;
    },
    [getCtx]
  );
  const connectSource = reactExports.useCallback(
    (src, stabOn, boosterVal) => {
  ...
  const pause = reactExports.useCallback(() => {
    ...
    try {
      (_a2 = sourceNodeRef.current) == null ? void 0 : _a2.stop();
    } catch {
    }
    sourceNodeRef.current = null;
    setIsPlaying(false);
  ...
  reactExports.useEffect(() => {
    ...
    const draw = () => {
      ...
      if (analyserRef.current) {
        ...
        dbLevel = rms > 0 ? Math.max(METER_MIN, Math.min(METER_MAX, 20 * Math.log10(rms))) : METER_MIN;
      }
      ...
      for (const db of TICKS) {
        ...
        ctx2d.strokeStyle = db >= -6 ? "#3a2020" : db >= -20 ? "#3a3820" : "#1e2a38";
        ctx2d.lineWidth = db === 0 || db === -20 ? 1.5 : 1;
        ctx2d.beginPath();
        ctx2d.moveTo(0, ty);
        ctx2d.lineTo(w, ty);
        ctx2d.stroke();
        ctx2d.fillStyle = db >= -3 ? "#ef4444" : db >= -6 ? "#f97316" : db >= -20 ? "#eab308" : "#4a5568";
      ...
      if (dbLevel > METER_MIN) {
        ...
        const peakColor2 = dbLevel >= -3 ? "#ef4444" : dbLevel >= -6 ? "#f97316" : dbLevel >= -20 ? "#eab308" : "#3b82f6";
        ctx2d.shadowColor = peakColor2;
        ctx2d.shadowBlur = 8;
        ctx2d.fillStyle = peakColor2;
  ...
  const peakColor = meterDb >= -3 ? "#ef4444" : meterDb >= -6 ? "#f97316" : meterDb >= -20 ? "#eab308" : "#3b82f6";
  const boosterColor = loudBooster > 170 ? "#ef4444" : loudBooster >= 130 ? "#f97316" : loudBooster >= 70 ? "#eab308" : "#3b82f6";
  const btnBase = {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "header",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rack-screw" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rack-screw" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h1",
                    {
                      ...
                      children: "POWER CORRECTION DISTORTION CENTER"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "AUDIO SIGNAL RESEARCH SYSTEM • WEB AUDIO API"
                    }
                  )
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "led active-green" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-7xl mx-auto w-full px-4 py-6 flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              onDrop,
              style: {
                border: isDragging ? "2px solid #3b82f6" : void 0,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#22334a" }, children: "MP3 · WAV · OGG · FLAC" })
                          ]
                        }
                      )
                    ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rack-panel rack-unit-border p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...btnBase,
                    padding: "8px 20px",
                    background: isPlaying ? "#0f1a2e" : "linear-gradient(180deg, #3b82f6 0%, #1d4ed8 100%)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...btnBase,
                    background: !isPlaying ? "#1a1a0a" : "linear-gradient(180deg, #facc15 0%, #b08800 100%)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rack-panel rack-unit-border p-4 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: "─── POWER CORRECTION SYSTEM ───"
                }
              ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
                        ...
                        letterSpacing: "0.1em",
                        textShadow: stabilizerOn ? "0 0 8px rgba(96,165,250,0.4)" : "none",
                        transition: "all 0.3s"
                      },
                      children: "STABILIZER"
                    }
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "WAVEFORM CORRECTION"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "toggle-switch", "data-ocid": "stabilizer.switch", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "checkbox",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "toggle-track" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `led ${stabilizerOn ? "active-green" : ""}` }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
                          ...
                          children: "GAIN SIGNAL CORRECTION — ALL COMBINED"
                        }
                      )
                    ] }),
                    [
                      ...
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: stabilizerOn ? "#facc15" : "#3a4a2a" }, children: val })
                        ]
                      },
                      label
                    )),
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              ...
                              children: "= 1.953125e33 → GAIN STAGE"
                            }
                          )
                        ]
                      }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: stabilizerOn ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      style: {
                        fontSize: "0.6rem",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: "GAIN STAGE CORRECTION: 1.953125e33 — ACTIVE"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "CORRECTION SYSTEM STANDBY" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            style: {
                            ...
                            children: "ENGAGE STABILIZER TO ACTIVATE"
                          }
                        )
                      ]
                    }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", style: { minWidth: 100 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
